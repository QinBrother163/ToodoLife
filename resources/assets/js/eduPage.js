...
function EduPage() {
    ...
    let nodeID = document.getElementById("edu-100");
    if (nodeID){
        ...
        this.layout.innerHTML =
            '<div id="edu-100" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="edu-101" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="edu-102" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="edu-103" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="edu-104" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="edu-105" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="edu-106" class="contain">' +
            '<img src=""/>' +
            '</div>';
        ...
        for (let i = 0; i < 7; ++i) {
            ...
            let node = this.layout.querySelector('#edu-10'+ i);
