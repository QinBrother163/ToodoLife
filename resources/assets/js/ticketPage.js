...
function TicketPage() {
    let nodeID = document.getElementById("ticket-0");
    if (nodeID) {
        ...
        this.layout.innerHTML =
            '<div id="ticket-0" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="ticket-1" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="ticket-2" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="ticket-3" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="ticket-4" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="ticket-5" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="ticket-6" class="contain">' +
            '<img src="" />' +
            '</div>';

        this.items = [];
        for (let i = 0; i < 7; ++i) {
            let node = this.layout.querySelector('#ticket-' + i);
