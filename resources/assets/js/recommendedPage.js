...
function RecommendedPage() {
    ...
    let nodeID = document.getElementById("contain-100");
    if (nodeID){
        ...
        this.layout.innerHTML =
            '<div id="contain-100" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="contain-101" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="contain-102" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="contain-103" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="contain-104" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="contain-105" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="contain-106" class="contain">' +
            '<img src=""/>' +
            '</div>';
        ...
        for (let i = 0; i < 7; ++i) {
            ...
            let node = this.layout.querySelector('#contain-10'+ i);
