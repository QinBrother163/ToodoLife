...
function ChildrenPage() {
    let nodeID = document.getElementById("children-0");
    if(nodeID){
        ...
        this.layout.innerHTML =
            '<div id="children-0" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-1" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-2" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-3" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-4" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-5" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-6" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-7" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="children-8" class="contain">'+
            '<img src="" />'+
            '</div>';

        this.items = [];
        for (let i = 0; i < 9; ++i) {
            let node = this.layout.querySelector('#children-'+ i);
