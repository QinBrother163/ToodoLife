...
function AttractionsPage() {
    ...
    let nodeID = document.getElementById("attractions-0");
    if (nodeID){
        ...
        this.layout.innerHTML =
            '<div id="attractions-0" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="attractions-1" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="attractions-2" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="attractions-3" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="attractions-4" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="attractions-5" class="contain">' +
            '<img src=""/>' +
            '</div>' +
            '<div id="attractions-6" class="contain">' +
            '<img src=""/>' +
            '</div>';
        ...
        for (let i = 0; i < 7; ++i) {
            ...
            let node = this.layout.querySelector('#attractions-'+ i);
