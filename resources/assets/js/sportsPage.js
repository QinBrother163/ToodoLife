...
function SportsPage() {
    let nodeID = document.getElementById("sports-0");
    if (nodeID) {
        ...
        this.layout.innerHTML =
            '<div id="sports-0" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-1" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-2" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-3" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-4" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-5" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-6" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-7" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-8" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="sports-9" class="contain">' +
            '<img src="" />' +
            '</div>';

        this.items = [];
        for (let i = 0; i < 10; ++i) {
            let node = this.layout.querySelector('#sports-' + i);
