...
function CharmGDPage() {
    let nodeID = document.getElementById("charmGD-0");
    if (nodeID) {
        ...
        this.layout.innerHTML =
            '<div id="charmGD-0" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="charmGD-1" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="charmGD-2" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="charmGD-3" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="charmGD-4" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="charmGD-5" class="contain">' +
            '<img src="" />' +
            '</div>' +
            '<div id="charmGD-6" class="contain">' +
            '<img src="" />' +
            '</div>';

        this.items = [];
        for (let i = 0; i < 7; ++i) {
            let node = this.layout.querySelector('#charmGD-' + i);
