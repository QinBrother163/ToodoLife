...
function RecreationPage() {
    let nodeID = document.getElementById("recreation-0");
    if(nodeID){
        ...
        this.layout.innerHTML =
            '<div id="recreation-0" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-1" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-2" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-3" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-4" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-5" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-6" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-7" class="contain">'+
            '<img src="" />'+
            '</div>'+
            '<div id="recreation-8" class="contain">'+
            '<img src="" />'+
            '</div>';

        this.items = [];
        for (let i = 0; i < 9; ++i) {
            let node = this.layout.querySelector('#recreation-'+ i);
